...
class ProfileTestClass(TestCase):
    # Set up method
    def setUp(self):
        self.Prof= Profile( id = '1', user ='moringa',bio='Wealthy', profile_picture = 'example.jpg',email='florachirry80@gmail.com',phone_number='0791409678',neighbourhood='Kitengela' )
